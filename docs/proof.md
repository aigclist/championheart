# Champion Heart Proof

This project should be judged by behavioral delta, not by rhetorical intensity.

## Evidence Cases

- `../cases/coding-case-01.md`
- `../cases/coding-case-02-coached.md`
- `../cases/coding-case-03-real-session.md`
- `../cases/research-case-01.md`
- `../cases/research-case-02-coached.md`
- `../cases/research-case-03-real-session.md`
