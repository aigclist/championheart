# Champion Heart Social Image Brief

## Master Spec

- master ratio: `4:5`
- master size: `1440 x 1800`
- safe zone: centered `1:1`
- platforms:
  - Xiaohongshu: `3:4`
  - Douyin: `9:16`
  - X: `1:1`
...
A premium black-and-gold furnace scene.

One central forged heart-core / emblem is being hammered into existence inside an obsidian forge.
Molten gold seams, engraved overwrite marks, and compressed force communicate:
...
Use at most one short title:

- `冠军之心`
- or `Champion Heart`

Prefer no other text.

## Final Prompt

```text
Create a premium social-media hero image for the project “Champion Heart / 冠军之心”.
...
Themes to communicate visually:
1. champion mindset
...
Style:
premium editorial fantasy-tech illustration
black, obsidian, charcoal, antique gold, molten gold
high contrast
clean silhouette
minimal clutter
dramatic lighting
luxury brand energy
hand-crafted, art-directed, cinematic, sharp
not anime
not game UI
not poster collage
not busy sci-fi city
not hacker-room imagery

Important composition rules:
- One dominant central forged heart/emblem
- Background secondary, atmospheric, and restrained
- Readable instantly on a phone screen
- Large shapes, strong contrast, no tiny interface details
- Leave safe margins for platform crops
- Center-weighted layout
- Optional small title only if it improves the image

Negative prompts:
generic cyberpunk clutter, neon blue-purple palette, stock photo humans, excessive text, too many small details, sci-fi cityscape, cheesy AI brain icon, cartoon heart, low contrast, UI overlays, random floating code, busy poster design
```

## Crop Guidance

- Keep the forged heart/emblem inside the center `70%`
- Keep optional title in upper-middle or lower-middle
- Avoid critical details in top/bottom `12%`
- Do not place transmission beams too close to edges
